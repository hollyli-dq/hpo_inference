...
class BasicUtils:
    ...
    def generate_partial_order(Z):
        ...
        Parameters:
        - Z: An n x K numpgeneratey array of latent positions.
    ...
    def compute_missing_relationships(
        ...
        missing = []
        n = h_true.shape[0]
        h_true_reduced = BasicUtils.transitive_reduction(h_true)
        h_final_reduced = BasicUtils.transitive_reduction(h_final)
        for i in range(n):
            for j in range(n):
